...
function Header({darkMode, setDarkMode}) {
  return (
    <div className="bg-red-900 fixed top-0 left-0 right-0 w-full py-6 px-16 lg:px-22 bg-slate-100/50 backdrop-blur-2xl dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700 z-10">
